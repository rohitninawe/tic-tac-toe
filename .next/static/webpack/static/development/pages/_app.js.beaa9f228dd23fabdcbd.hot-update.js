  ...
  function TicTacToe(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "botMove", function (cls) {
      ...
      if (!_this.state.tictoc) {
        ...
        if (oddNos.length > 0) {
          var _id16 = oddNos[Math.floor(Math.random() * oddNos.length)](document.getElementById(_id16).innerHTML = 'O') && (document.getElementById(_id16).style.textShadow = '6px 6px 21px #92bae2') && _this.setState({
            tictoc: true
          });
        } else if (evenNos.length > 0) {
          var _id17 = evenNos[Math.floor(Math.random() * evenNos.length)](document.getElementById(_id17).innerHTML = 'O') && (document.getElementById(_id17).style.textShadow = '6px 6px 21px #92bae2') && _this.setState({
            tictoc: true
          });
        }
      } // this.setState({
...
//# sourceMappingURL=_app.js.beaa9f228dd23fabdcbd.hot-update.js.map