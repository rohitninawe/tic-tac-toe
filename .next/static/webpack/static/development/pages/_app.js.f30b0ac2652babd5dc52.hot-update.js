      ...
      if (_this.state.won == false) {
        if (document.getElementById(id).innerHTML === '') {
          ...
          if (_this.state.p2 == 'Computer' && _this.state.tictoc) {
            console.log('By computer')((document.getElementById(id).innerHTML = 'X') && (document.getElementById(id).style.textShadow = '6px 6px 21px #d2d282'));
          } else if (_this.start.p2 != 'Computer') {
            console.log('No Computer')((document.getElementById(id).innerHTML = val) && (document.getElementById(id).style.textShadow = val == 'X' ? '6px 6px 21px #d2d282' : '6px 6px 21px #92bae2'));
          }
...
//# sourceMappingURL=_app.js.f30b0ac2652babd5dc52.hot-update.js.map