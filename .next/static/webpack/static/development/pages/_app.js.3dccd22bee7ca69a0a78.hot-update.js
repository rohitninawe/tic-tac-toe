...
function (_PureComponent) {
  ...
  function _app(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "callWinner", function () {
      ...
      if (u1 != '' && u2 != '' && u3 != '') {
        if (u1 === u2 && u1 == u3) {
          document.getElementById('u1').className = 'spinner lu sepBox';
          document.getElementById('u2').className = 'spinner sepBox';
          document.getElementById('u3').className = 'spinner ru sepBox';
...
//# sourceMappingURL=_app.js.3dccd22bee7ca69a0a78.hot-update.js.map