...
function (_PureComponent) {
  ...
  function _app(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "callWinner", function () {
      ...
      if (u1 != '' && u2 != '' && u3 != '') {
        if (u1 === u2 && u1 == u3) {
          document.getElementById('u1').className = 'jsx-2697416462 spinner lu sepBox';
          document.getElementById('u2').className = 'jsx-2697416462 spinner sepBox';
          document.getElementById('u3').className = 'jsx-2697416462 spinner ru sepBox';
...
//# sourceMappingURL=_app.js.0c0066c74d7af5efb0f1.hot-update.js.map